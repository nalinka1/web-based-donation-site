...
<head>
<title>profile</title>
	<link rel="stylesheet" type="text/css" href="css/profile123.css">
...
<body>
	...
	<div id="main-content">
		...
		<img src="css/images/profile.png" class="icon">
			...
			<form class="form" action="loginSetting.php" method="post" enctype="multipart/form-data" autocomplete="off">
