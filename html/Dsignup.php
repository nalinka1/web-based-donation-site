...
<title> Donar Sign up</title>
	<link rel="stylesheet" type="text/css" href="css/Dsignup123.css">
	<link rel="icon" href="css/images/cc1.png">
...
<body>
	...
	<div id="main-content">
		...
		<img src="css/images/profile.png" class="icon">
			...
			<form class="form" action="donarDetails.php" method="post" enctype="multipart/form-data" autocomplete="off">
				<div id="first">
				<p>First Name</p>
				...
				<p>Confirm Password</p>
					<input type="password" name="re_password" placeholder="Enter password" autocomplete="new-password" required/>
				<p>Profile picture(<3Mb)</p>
					<input type="file" name="profile" >
				<input type="checkbox" name="show" value="yes"><h3>display profile</h3><br>
